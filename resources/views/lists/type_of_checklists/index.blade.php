    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="alert alert-light alert-elevate" role="alert">
            ...
            <div class="alert-text">
                Управление справочником "Типы чек-листов". <br>
                <u>Функционал:</u>
                <ul>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLongTitle">Тип чеклиста</h5>
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Название типа:</label>
                                        <div class="col-lg-9">
        ...
        let KTDatatablesDataSourceAjaxServer = function() {
            ...
            let newPosition = function() {
                newButton.on('click', function (el) {
                    form.attr('action', '{{ route('typeofchecklists.store') }}');
            ...
            let deletePosition = function(DTtable) {
                ...
                table.on('click', '.positionsDelete', function(e){
                    ...
                    if (confirm("Удалить элемент")) {
                        $.ajax({
                            url: '/api/typeofchecklists/'+record_id,
                            method: 'POST',
                            data: {
                                _method: 'DELETE',
                            },
            ...
            let editPosition = function(DT_table) {
                table.on('click', '.positionsEdit', function(e){
                    let record_id = this.closest('tr').getAttribute('id').slice(4);
                    $.get("{{ route('typeofchecklists.index') }}" +'/' + record_id, function (response) {
                        form.attr('action', '{{ route('typeofchecklists.index') }}' + '/' + response.data.id);
                        let el = '<input type="hidden" name="type_of_checklist_id" value="'+response.data.id+'" />';
                        form.append(el);
