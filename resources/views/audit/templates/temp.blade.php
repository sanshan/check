                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select style="width:100%" class="form-control m-select2" id="gas-station-types" name="types_of_gas_station[]" multiple="multiple">
                                            </select>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select style="width:100%" class="form-control m-select2" id="type-of-checklist" name="type_of_checklist">
                                                </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select style="width:100%" class="form-control m-select2" id="regions" name="regions[]" multiple="multiple">
                                            </select>
...
@push('scripts')
    <script>
        ...
        let KTDatatablesDataSourceAjaxServer = function() {
            ...
            let templateSectionsList = $('#templateQuestionsList');
            ...
            let showPosition = function(DTtable) {
                table.on('click', '.model-show', function (e) {
                    ...
                    let templateQuestionsDT= initTemplateSections(modelId);
            ...
            let initTemplateSections = function(modelId) {
                templateSectionsList.DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '/api/templates/'+modelId+'/sections',
                    orderFixed: [0, 'asc'],
                    order: [[0, 'asc']],
                    language: {
                        url: "//cdn.datatables.net/plug-ins/1.10.19/i18n/Russian.json",
