...
return [
    ...
    */
    'attributes'           => [
        'title'                => 'Название',
        'gas_station_region'   => 'Регион АЗС',
        'user_region'          => 'Регион пользователя',
        'region'               => 'Регион',
        'regions'              => 'Регионы',
        'types_of_gas_station' => 'Тип ТЗК',
        'type_of_checklist'    => 'Тип проверки',
        'number'               => 'Номер',
        'address'              => 'Адрес',
        'is_shop'              => 'Магазин',
        'it_works'             => 'Статус',
        'dir_name'             => 'Имя директора',
        'dir_patronymic'       => 'Отсество директора',
        'dir_surname'          => 'Фамилия директора',
        'email'                => 'Почта',
        'phone'                => 'Телефон',
        'gas_station'          => 'АЗС',
        'positions'            => 'Должность',
        'positions.*'          => 'Должность',
        'template'             => 'Шаблон',
        'present_in_template'  => 'В шаблоне',
        'missing_in_template'  => 'Не в шаблоне',
        'weight'               => 'Вес',
    ],
];
